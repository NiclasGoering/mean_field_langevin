...
def main():
    ...
    # --- Save directory ---
    base_save_dir = Path("/home/goring/mean_field_langevin/Index/results/1809_d30_k7_p3_g0.25")
    ...
    P_values = [1000,10000,50000,100000]#[10, 100, 500, 750, 1000, 2133, 3666, 5000, 7500,10000,20000,50000]  #
    P_values = sorted(P_values, reverse=True)  # descending

    # kappa ascending (start from smallest kappa)
    kappa_0_values = [5e-5] #,7.5e-3, 1e-2, 1e-3, 5e-3, 7.5e-2, 2.5e-2, 5e-2]  # more: [7.5e-3, 1e-2, 1e-1, 1e-3, 5e-3, 7.5e-2, 2.5e-2, 5e-2, 5e-4]
