...
if __name__ == "__main__":
    ...
    P_train_list = [500,10,2000]#[10000, 10, 100, 500, 750, 1000, 2133, 3666, 5000, 7500]
    kappa_list   = [5e-3]
    num_exp = 3
    base_seed = 123456
    ...
    algo = Algo(
        outer_steps=75_000, inner_mala_steps=20, step_size=3e-7, use_mala=True,
    ...
    alpha0 = 0.1
    beta01 = alpha0 / d
    ard = ARD(use_ard=False, alpha0=alpha0, ema=0.25, update_every=1,
