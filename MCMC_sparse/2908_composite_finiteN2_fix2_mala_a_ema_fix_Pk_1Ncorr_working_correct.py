...
class RSCavityExplicitMulti:
    ...
    def run(self, X: torch.Tensor, y: torch.Tensor, out_dir: str, tag: str="", dev_tag: str=""):
        ...
        eta = self.algo.step_size * (self.kappa if self.algo.linear_kappa_step else 1.0)
        if P <= 100:
...
if __name__ == "__main__":
    ...
    kappa_list   =   [5e-4] #[1e-2,7.5e-2, 2.5e-2, 5e-2] # [7.5e-3, 1e-3, 5e-3, 5e-4]
    num_exp = 3
    base_seed = 123456
    ...
    algo = Algo(
        outer_steps=30_000, inner_mala_steps=50, step_size=7e-8, use_mala=False, #0005
        log_every=50, cg_like_update=True, field_blend=0.2,
    ...
    out_dir = "/home/goring/mean_field_langevin/MCMC_composite/results_d35k4hm_paper_plot/ard_1_inner100_last_7e-8"
