...
class RSCavityExplicitMulti:
    ...
    def run(self, X: torch.Tensor, y: torch.Tensor, out_dir: str, tag: str="", dev_tag: str=""):
        ...
        # effective step size (optionally scaled with kappa)
...
if __name__ == "__main__":
    ...
    algo = Algo(
        outer_steps=250_000, inner_mala_steps=250, step_size=1e-2, use_mala=False,
        log_every=500, cg_like_update=True, field_blend=0.9,
    ...
    out_dir = "/home/goring/mean_field_langevin/MCMC_composite/results_d35k4hm_paper_final_conv/ard_0.01_inner100_7.5e-3"
