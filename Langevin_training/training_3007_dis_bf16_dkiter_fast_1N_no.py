...
def main():
    ...
    # --- Save directory ---
    base_save_dir = Path("/home/goring/mean_field_langevin/Langevin_training/results_paper1/d35_k4_lr5e-4")
    ...
    P_values = [10, 100, 500,750, 1000,2133,3666, 5000, 7500, 10000, 20000]  # add more if needed
    P_values = sorted(P_values, reverse=True)  # descending

    # kappa ascending (start from smallest kappa)
    kappa_0_values = [7.5e-3, 1e-2, 1e-1, 1e-3, 5e-3,7.5e-2,2.5e-2, 5e-2, 5e-4]
